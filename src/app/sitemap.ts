...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE}/fensterreparatur`,         lastModified: NOW, changeFrequency: 'monthly', priority: 0.85 },
    { url: `${BASE}/dichtungstausch`,          lastModified: NOW, changeFrequency: 'monthly', priority: 0.85 },
    { url: `${BASE}/fensterwartung`,           lastModified: NOW, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE}/fenstermontage`,           lastModified: NOW, changeFrequency: 'monthly', priority: 0.85 },
    { url: `${BASE}/glasreparatur`,            lastModified: NOW, changeFrequency: 'monthly', priority: 0.85 },
    { url: `${BASE}/blindscheiben-tausch`,     lastModified: NOW, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE}/einbruchschutz-nachruestung`, lastModified: NOW, changeFrequency: 'monthly', priority: 0.85 },
    { url: `${BASE}/velux-reparatur`,          lastModified: NOW, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE}/rollladen-jalousien-reparatur`, lastModified: NOW, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE}/sonnenschutzfolien`,       lastModified: NOW, changeFrequency: 'monthly', priority: 0.75 },
    { url: `${BASE}/raffstore-textband-tausch`, lastModified: NOW, changeFrequency: 'monthly', priority: 0.75 },
