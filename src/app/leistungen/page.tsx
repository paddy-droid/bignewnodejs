...
{/* Placeholder for a relevant image */}
      ...
      <section className="bg-brand text-white py-16 text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold mb-6 text-white">Bereit für erstklassigen Fensterservice?</h2>
          <p className="text-xl mb-10 max-w-3xl mx-auto text-white">Kontaktieren Sie uns noch heute für eine unverbindliche Beratung oder einen Termin.</p>
