    ...
    <main>
      ...
      <section className="container mx-auto px-4 py-12 bg-gray-100">
        ...
        <div className="mb-8 p-6 bg-white rounded-lg shadow-md">
          ...
          <p className="mb-4">
            Ein defektes Fenster kann viele Ursachen haben – von altersbedingtem Verschleiß über Einbruchschäden bis hin zu Problemen mit Beschlägen oder Dichtungen. Unsere Experten analysieren das Problem schnell und präzise und führen die notwendigen Reparaturen durch. Wir reparieren Fenster aller Art und Materialien, einschließlich Holz-, Kunststoff- und Aluminiumfenster. Häufige Reparaturen umfassen den Austausch defekter Beschläge, die Reparatur von Rahmen, den Austausch von Glasscheiben (auch Isolierglas), die Erneuerung von Dichtungen und die Behebung von Klemmproblemen. Eine zeitnahe Reparatur ist wichtig, um größere Schäden zu vermeiden und die volle Funktionalität Ihres Fensters wiederherzustellen. Wir verwenden ausschließlich hochwertige Ersatzteile, um eine langanhaltende Lösung zu gewährleisten. Unsere Reparaturdienste sind schnell, effizient und kostengünstig. Wir verstehen, dass ein defektes Fenster ein Sicherheitsrisiko darstellen kann, daher bieten wir auch Notfallreparaturen an. Vertrauen Sie auf unsere Expertise, um Ihre Fenster wieder in Top-Zustand zu bringen.
          </p>
        </div>
        ...
        <div className="mb-8 p-6 bg-white rounded-lg shadow-md">
          ...
          <p className="mb-4">
            Die Sicherheit Ihrer Fenster ist uns ein wichtiges Anliegen. Wir bieten Nachrüstlösungen zur Erhöhung des Einbruchschutzes Ihrer bestehenden Fenster. Dazu gehören die Montage von Sicherheitsbeschlägen, abschließbaren Fenstergriffen, Zusatzschlössern und einbruchhemmendem Glas. Wir beraten Sie individuell zu den besten Sicherheitsmaßnahmen für Ihre spezifische Situation und führen die Installation fachgerecht durch. Ein effektiver Einbruchschutz schreckt potenzielle Täter ab und gibt Ihnen ein Gefühl der Sicherheit in Ihrem Zuhause. Wir sind stets auf dem neuesten Stand der Sicherheitstechnik und bieten Lösungen, die den aktuellen Empfehlungen der Polizei entsprechen.
          </p>
        </div>
        ...
        <div className="mb-8 p-6 bg-white rounded-lg shadow-md">
          ...
          <p className="mb-4">
            Beschädigtes Glas ist nicht nur ein ästhetisches Problem, sondern kann auch die Energieeffizienz und Sicherheit Ihres Fensters beeinträchtigen. Wir tauschen beschädigte oder gesprungene Glasscheiben schnell und professionell aus. Wir arbeiten mit verschiedenen Glasarten, einschließlich Isolierglas, Sicherheitsglas und Schallschutzglas.
          </p>
        </div>
      </section>
