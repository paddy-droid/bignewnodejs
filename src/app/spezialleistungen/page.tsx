    ...
    <>
      ...
      <section className="container mx-auto px-4 py-12">
       ...
       {/* Relevant image for Spezialleistungen page */}
         <Image src="/Images/fensterreparatur_wien_1_1777634178089.png" alt="ROWO Spezialleistungen: Maßgeschneiderte Lösungen für komplexe Fensterreparaturen" width={800} height={600} className="w-full h-auto max-h-96 object-cover mb-6 rounded-md"/>
       </section>
      ...
      <section className="bg-brand text-white py-16 text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold mb-6 text-black">Haben Sie besondere Anforderungen an Ihre Fenster?</h2>
          <p className="text-xl mb-10 max-w-3xl mx-auto text-black">Kontaktieren Sie uns für eine individuelle Beratung zu unseren Spezialleistungen.</p>
