...
{/* Placeholder for a relevant image */}
      ...
      <section className="bg-brand text-white py-16 text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold mb-6">Haben Sie besondere Anforderungen an Ihre Fenster?</h2>
          <p className="text-xl mb-10 max-w-3xl mx-auto">Kontaktieren Sie uns für eine individuelle Beratung zu unseren Spezialleistungen.</p>
