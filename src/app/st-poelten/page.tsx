        ...
        <section className="container mx-auto px-4 py-12">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl mb-12 group">
              <Image src="/Images/Fenster Reparatur.png" alt="Fensterservice St. Pölten" width={1200} height={600} className="w-full h-[400px] md:h-[500px] object-cover transition-transform duration-700 group-hover:scale-105" />
